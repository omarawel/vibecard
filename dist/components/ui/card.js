...
const Card = React.forwardRef((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ ref: ref, className: (0, utils_1.cn)("rounded-lg border border-slate-200 text-slate-950 shadow-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50", className) }, props)));
});
exports.Card = Card;
...
const CardDescription = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("p", Object.assign({ ref: ref, className: (0, utils_1.cn)("text-sm text-slate-500 dark:text-slate-400", className) }, props)));
});
